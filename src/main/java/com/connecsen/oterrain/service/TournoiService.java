...
private EquipeRepository equipeRepository;
	...
	@Override
	public EquipeDtoResponse addEquipeToTournoi(Long id, EquipeDtoRequest equipeDtoRequest) {
		Tournoi tournoi = tournoiRepository.getById(id);
		Equipe equipe = Utility.equipeDtoRequestConvertToEquipe(equipeDtoRequest);
		Equipe equipeSave = equipeRepository.save(equipe);
		tournoi.getEquipes().add(equipeSave);
		Tournoi tournoiSave =tournoiRepository.save(tournoi);
		Utility.tournoiConvertToTournoiDtoResponse(tournoiSave);
		return Utility.equipeConvertToEquipeDtoResponse(equipeSave);
	}
